"""Train and refresh the ERMS anomaly model from static or live sensor log files.

Examples:
    py -3.14 ml/train_model.py
    py -3.14 ml/train_model.py --input sensor_data.log --watch --poll-seconds 5
"""
...
DEFAULT_BASELINE = ROOT / "src" / "assets" / "hazard_data.csv"
DEFAULT_INPUT = ROOT / "sensor_data.log"
DEFAULT_OUTPUT = ROOT / "public" / "ml_predictions.json"
